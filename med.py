...
class Pharmacy:
    def __init__(self, root):
        ...
        self.root.iconbitmap(r"F:\pharmacyyy\image\doc.ico")
        ...
        ######### pharmacy logo label #######
        img1 = Image.open(r"F:\pharmacyyy\image\new.png")
        ...
        # image 1
        self.bg = ImageTk.PhotoImage(file=r"F:\pharmacyyy\image\med.jpg")
        lbl_bg = Label(left_smallframe, image=self.bg)
        lbl_bg.place(x=370, y=165, width=200, height=150)
        # image 2
        self.bgg = ImageTk.PhotoImage(file=r"F:\pharmacyyy\image\medi.jpg")
        ...
        # image 1
        self.bg1 = ImageTk.PhotoImage(file=r"F:\pharmacyyy\image\co.jpg")
        lbl_bg1 = Label(right_frame, image=self.bg1)
        lbl_bg1.place(x=0, y=0, width=240, height=100)
        # image 2
        self.bg2 = ImageTk.PhotoImage(file=r"F:\pharmacyyy\image\inject.jpg")
